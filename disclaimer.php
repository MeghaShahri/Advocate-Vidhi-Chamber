...
<html>
<head>
        <title>Vidhi Chambers-Disclaimer</title>
...
<style>
/* html { 
  background: url(img/flag1.png) no-repeat center center fixed; 
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">VIDHI CHAMBERS</h5>
        ...
        <div class="modal-body">
          <p style="color:black;">Disclaimer & Confirmation As per the rules of the Bar Council of India,law firms are not permitted to
              solicit work and advertise.<br><br>By clicking on the "I AGREE" button below,user acknowledges the following:<br><br>
        ...
        <div class="modal-footer">
          <button type="button" class="btn" style="background:white; color:black;" id="agree" onclick="location.href='home.php';" >I Agree</button> 
        </div>
      </div>
    </div>
  </div>
